...
(
  ...
  REGISTER_R_CE_24 #(.N(4)) bit_counter (
    .q(bit_counter_value),
    .d(bit_counter_next),
    .ce(bit_counter_ce),
    .rst(bit_counter_rst),
  ...
  REGISTER_R_CE_24 #(.N(CLOCK_COUNTER_WIDTH)) clock_counter (
  ...
  wire has_byte;
  REGISTER_R_CE_24 #(.N(1)) has_byte_reg (
    .q(has_byte),
    .d(1'b1),
    .ce(done),
    .rst(data_out_fire),
  ...
  wire start;
  REGISTER_R_CE_24 #(.N(1)) start_reg (
    .q(start),
    .d(1'b1),
