...
xfile add "../rtl/ddr2_tb_test_addr_gen.v"
xfile add "../rtl/ddr2_tb_test_cmp.v"
xfile add "../rtl/ddr2_tb_test_data_gen.v"
xfile add "../rtl/ddr2_tb_test_gen.v"
xfile add "../rtl/ddr2_tb_top.v"
...
xfile add "../rtl/mig_xupv5.v"

xfile add "mig_xupv5.ucf"
...
project set "Library Search Order" "../synth/mig_xupv5.lso" -process "Synthesize - XST"
