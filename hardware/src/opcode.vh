...
`define CTYPE   6'b010000 //ISR//
// COP0 moves from/to identified by $rs value: //ISR//
    `define COP0_FROM   5'b00000 //from (like load/read) //ISR//
    `define COP0_TO     5'b00100 //to (like store/write) //ISR//
